...
-- Source of truth for the local PostgreSQL database. See db/schema.ts for the typed export.
...
CREATE INDEX IF NOT EXISTS collector_logs_platform_started_idx ON collector_logs(platform, started_at DESC);
